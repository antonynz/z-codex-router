...
Before proposing a change, run formatting, unit tests, Clippy, plugin validation, every skill validation, and the repository secret/path scan. Installer tests must use a temporary `CODEX_HOME`; never use a developer's real Codex directory.
